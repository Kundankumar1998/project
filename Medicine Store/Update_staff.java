...
import java.sql.*;
import javax.swing.*;
public class Update_staff extends Frame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==b1)
        {
            ...
            try
            {
                ...
                if(data.equals("Name"))
                {
                    st.executeUpdate("update staff set name=('"+Value+"') where id=("+id+")");
                ...
                {
                    st.executeUpdate("update staff set password=('"+Value+"') where id=("+id+")");
                    msg_l.setText("Update Succesfully");
                    temp++;  
                    con.close();      
                }else
                ...
                {
                    st.executeUpdate("update staff set mobile=('"+Value+"') where id=("+id+")");
                    msg_l.setText("Update Succesfully");
                    temp++;  
                    con.close();      
                }else
                ...
                {
                    st.executeUpdate("update staff set salary=('"+Value+"') where id=("+id+")");
                    msg_l.setText("Update Succesfully");
                    temp++;  
                    con.close();      
                }else
                ...
                {
                    st.executeUpdate("update staff set email=('"+Value+"') where id=("+id+")");
                    msg_l.setText("Update Succesfully");
                    temp++;  
                    con.close();      
                }else
                ...
                {
                    st.executeUpdate("update staff set Address=('"+Value+"') where id=("+id+")");
                    msg_l.setText("Update Succesfully");
                    temp++;  
                    con.close();      
                }
